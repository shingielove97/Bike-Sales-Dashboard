...
3. Which age groups are most likely to purchase bikes?
...
## Process
1. Cleaned dataset and removed inconsistencies.
2. Created customer segments:
Age Brackets (Adolescent, Middle Age, Old)
Commute Distance Categories
3. Applied data segmentation:
Gender
Marital Status
Region
Education
4. Developed key measures:
Average Income
Bike Purchase Count
...
Younger and older groups show low engagement in bike purchases.
Gender insights:
Males have higher average income
Female buyers show strong participation relative to income

 ## Strategic Insights
Focus marketing on urban, short-distance commuters
Position bikes as affordable and practical transport solutions
Expand into:
Fitness & lifestyle segments (younger audience)
